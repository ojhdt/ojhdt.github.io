...
详细说明请参见 [附录](https://ojhdt.club/20181002/hexo-markdown/)。
...
>建议在 **安装好主题后** 再进行此步操作。有关主题安装内容请查阅[本教程 主题 篇](https://ojhdt.club/20180804/hexo-2/)。
>
...
>
>下一篇：[离Hexo博客搭建只差一个教程（二）：主题](https://ojhdt.club/20180804/hexo-2)
